...
-  [`babashka.http-client`](#babashka.http-client) 
    ...
    -  [`->ProxySelector`](#babashka.http-client/->ProxySelector) - Constructs a <code>java.net.ProxySelector</code> from a map of options, or from a function of a <code>java.net.URI</code> returning such a map to select a proxy per request.
...
-  [`babashka.http-client.interceptors`](#babashka.http-client.interceptors) 
    ...
    -  [`request-method`](#babashka.http-client.interceptors/request-method) - Request: normalize :method option.
...
Constructs a `java.net.Authenticator`.
  ...
  * `:user` - the username
  * `:pass` - the password
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L43-L51">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L53-L61">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L9-L22">Source</a></sub></p>
...
Constructs a `javax.net.ssl.SSLContext`.
  ...
  * `:insecure` - if `true`, an insecure trust manager accepting all server certificates will be configured.
  ...
  properties globally.
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L24-L41">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L63-L71">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L82-L105">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L171-L178">Source</a></sub></p>
...
Perform request. Returns map with at least `:body`, `:status`
  ...
  * `:version` - the HTTP version: `:http1.1` or `:http2`.
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client.clj#L107-L132">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L222-L229">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L269-L281">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L254-L267">Source</a></sub></p>
...
## <a name="babashka.http-client.interceptors/request-method">`request-method`</a><a name="babashka.http-client.interceptors/request-method"></a>




Request: normalize :method option
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L231-L238">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L243-L252">Source</a></sub></p>
...
<p><sub><a href="https://github.com/babashka/http-client/blob/main/src/babashka/http_client/interceptors.clj#L240-L241">Source</a></sub></p>
